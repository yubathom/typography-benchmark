const System: React.FC<{ auth: any, authError: boolean }> = (props): JSX.Element => {
	return <section className="w-full">
		<h1 className="font-semibold text-3xl mt-5 mb-2">System typefaces</h1>
		<h2 className="mb-10">Default system fonts, Roboto prioritized</h2>
		...
		<pre className="font-mono p-4 text-xs leading-snug text-white bg-black bg-opacity-75 mt-10 rounded-lg">
			font-family: <br />
			<span className="text-pink-300">'Roboto'</span>, <br />
			'ui-sans-serif',  <br />
			'system-ui',  <br />
			'-apple-system',  <br />
		...
		<p className="text-sm mt-1">Source of the glyphs: System</p>
